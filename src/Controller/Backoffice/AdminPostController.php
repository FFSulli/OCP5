...
class AdminPostController
{
    ...
    public function __construct(Request $request, View $view, Session $session, PostRepository $postRepository, UserRepository $userRepository, PostFormValidator $postFormValidator, Authentication $authentication)
    {
